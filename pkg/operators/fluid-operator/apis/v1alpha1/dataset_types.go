...
import (
	...
	"github.com/kubeflow/arena/pkg/operators/fluid-operator/common"
...
func (d *Dataset) UFSTotalSize() string {
	return d.Status.UfsTotal
}

func (d *Dataset) CacheSize() string {
	return d.Status.CacheStates[common.Cached]
}

func (d *Dataset) CacheCapacity() string {
	return d.Status.CacheStates[common.CacheCapacity]
}

func (d *Dataset) CachePercentage() string {
	return d.Status.CacheStates[common.CachedPercentage]
}

func (d *Dataset) Phase() DatasetPhase {
	return d.Status.Phase
}

func (d *Dataset) Age() string {
	return translateTimestamp(d.ObjectMeta.CreationTimestamp)
}
